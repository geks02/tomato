    ...
    <div className="mx-auto max-w-4xl px-4 py-6 space-y-6">
      ...
      <div className="rounded-xl bg-white p-4 shadow-sm space-y-3">
        ...
        <button
          ...
          py-3 text-sm font-semibold text-white hover:bg-blue-500 disabled:opacity-50 "
        >
          {loadingRazorpay ? (
        ...
        <button
          ...
          py-3 text-sm font-semibold text-white hover:bg-gray-800 disabled:opacity-50 "
        >
          {loadingRazorpay ? (
            <BiLoader size={18} className="animate-spin " />
          ) : (
